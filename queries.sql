...
SELECT first_name, last_name
FROM employees
WHERE birth_date BETWEEN '1953-01-01' AND '19953-12-31'

-- Employees born in 1954
SELECT first_name, last_name
FROM employees
WHERE birth_date BETWEEN '1954-01-01' AND '19954-12-31'
...
INTO sales_info
FROM retirement_info as ri
FULL OUTER JOIN dept_info as di
ON (ri.emp_no) = (di.emp_no);

SELECT * FROM sales_info;

-- List for Sales and DEV Team
SELECT ri.emp_no,
ri.first_name,
ri.last_name,
di.dept_name
